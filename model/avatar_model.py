...
from model.mesh_render import render_and_save
from model.save_ply import save_point_cloud_to_ply
#from model.point_render import render_point_cloud
...
class AvatarModel:
    ...
    def net_set(self, mode):
        ...
        self.net = POP_no_unet(
            c_geom=self.net_parms.c_geom,
            geom_layer_type=self.net_parms.geom_layer_type,
            nf=self.net_parms.nf,
            hsize=self.net_parms.hsize,
            up_mode=self.net_parms.up_mode,
            use_dropout=bool(self.net_parms.use_dropout),
            uv_feat_dim=2,
        ).cuda()
    ...
    def train_stage1(self, batch_data, iteration):
        ...
        # live_smpl is a class of SMPLOutput
        ...
        image = batch_data['original_image']
        normal = batch_data['normal'].permute(0,3,1,2)
