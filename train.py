        ...
        for _, batch_data in enumerate(train_loader):
            ...
            with torch.no_grad():
                ...
                if (first_iter-1) % opt.log_iter == 0:
                    ...
                    torchvision.utils.save_image(image, os.path.join(model.model_path, 'log', '{0:005d}_pred'.format(first_iter) + ".png"))
                    torchvision.utils.save_image(gt_image, os.path.join(model.model_path, 'log', '{0:005d}_gt'.format(first_iter) + ".png"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_epochs", nargs="+", type=int, default=[300])
