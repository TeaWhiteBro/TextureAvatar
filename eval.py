...
if __name__ == "__main__":
    ...
    # backup
    os.system('cp train.py ' + args.model_path + '/' + 'train.py')
    os.system('cp eval.py ' + args.model_path + '/' + 'eval.py')
    os.system('cp model/avatar_model.py ' + args.model_path + '/' + 'avatar_model.py')
    os.system('cp model/modules.py ' + args.model_path + '/' + 'modules.py')
    os.system('cp model/network.py ' + args.model_path + '/' + 'network.py')